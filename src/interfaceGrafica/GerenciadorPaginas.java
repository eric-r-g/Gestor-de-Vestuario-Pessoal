...
public class GerenciadorPaginas {
	...
	protected JanelaLavagemListar JLaListar;
	protected  JanelaItensAdd JIAdd;
	protected  JanelaLookAdd JLAdd;
	...
	public GerenciadorPaginas(){
			...
			emprestimoManager = new EmprestimoManager(bdManager, itemManager);
			lavagemManager = new LavagemManager();
	}
	...
	public void criarJanela() {
		...
		JIAdd = new JanelaItensAdd(this, itemManager);
		...
		JLAdd = new JanelaLookAdd(this, lookManager, itemManager);
		cardPanel.add(JLAdd, "TELA_LOOKS_ADICIONAR");
		
		JEListar = new JanelaEmprestimoListar(this, emprestimoManager, bdManager);
		cardPanel.add(JEListar, "TELA_EMPRESTIMOS_LISTAR");
		
		JLaListar = new JanelaLavagemListar(this, lavagemManager, itemManager, bdManager);
		cardPanel.add(JLaListar, "TELA_LAVAGENS_LISTAR");
		
		JanelaEmprestimoAdd JEAdd = new JanelaEmprestimoAdd(this, emprestimoManager, itemManager);
		cardPanel.add(JEAdd, "TELA_EMPRESTIMOS_ADICIONAR");
	...
	public void mostrarTela(String nomeTela) {
        ...
        if (nomeTela.equals("TELA_ITENS_LISTAR")) {
        	...
        	JIAdd.itemEditar = null;
        } else if (nomeTela.equals("TELA_LOOKS_LISTAR")) {
        	JLListar.atualizarListagem();
        } else if (nomeTela.equals("TELA_EMPRESTIMOS_LISTAR")) {
        		JEListar.atualizarListagem();
        } else if (nomeTela.equals("TELA_LAVAGENS_LISTAR")) {
    		JLaListar.atualizarListagem();
        }
    }
