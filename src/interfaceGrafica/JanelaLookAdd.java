...
public class JanelaLookAdd extends ModeloPagina{
	...
	protected void modoEdicao() throws ArrayVaziaException, ElementoInexistenteException {
		...
		ComboItem acessorio = new ComboItem("", null);
		ComboItem unica = new ComboItem("", null);
		ComboItem superior = new ComboItem("", null);
		ComboItem inferior = new ComboItem("", null);
	...
	static class ComboItem {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(modelo, comboItem.modelo) && 
                   Objects.equals(id, comboItem.id);
        }

        
        public int hashCode() {
            return Objects.hash(modelo, id);
        }
    }
        		...
        		try {
	                ...
	                if(lookEditar == null) {
	                	...
	                	try {
		                	...
		                	ArrayList <Item> novo = new ArrayList<Item>();
		                	if(acessorio != null) novo.add(acessorio);
		                	if(unica != null) novo.add(unica);
		                	if(calcado != null) novo.add(calcado);
		                	if(superior != null) novo.add(superior);
		                	if(inferior != null) novo.add(inferior);
		                	lookManager.atualizarLook(lookManager.RetornarItemPorId(lookEditar), novo);
		                	lookManager.atualizarBD();
		                } catch (Exception erro) {
		                	System.out.print(erro);
		                }
